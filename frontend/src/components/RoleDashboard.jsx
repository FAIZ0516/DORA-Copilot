...
export default function RoleDashboard({ projectKey, databaseConnected, onAsk, onSuggest = onAsk, disabled = false }) {
  ...
  const connectionState = databaseConnected == null ? "connecting" : databaseConnected ? "connected" : "offline";
  const connectionLabel = databaseConnected == null ? "Connecting to DoraDB" : databaseConnected ? "Live DoraDB" : "Database unavailable";
  const reportScope = {
