      ...
      <main>
        <section className="hero" id="assistant">
          ...
          <div className="content-width hero-content">
            <div className="hero-copy">
              ...
              <p>
                Ask a real DeepSeek AI agent about DORA performance, release trends,
        ...
        <section className="capability-strip content-width" id="capabilities">
          <div className="capability-card active">
            <Bot size={24} />
            <div><strong>Generative AI</strong><span>DeepSeek conversation</span></div>
          </div>
          ...
          <div className="content-width trust-inner">
            ...
            <div className="trust-grid">
              <article>
                <span>01</span>
                <h3>Plan</h3>
                <p>DeepSeek understands intent and proposes an approved data strategy.</p>
              </article>
              <article>
                <span>02</span>
                <h3>Control</h3>
