...
def test_deepseek_remains_the_default_provider() -> None:
    settings = Settings(_env_file=None)

    assert settings.llm_provider == "deepseek"
    assert settings.llm_model == settings.deepseek_model
    assert settings.llm_source == f"deepseek:{settings.deepseek_model}"
